        ...
        <div className="about-container">
            ...
            <div className="about-main">
                <p className="about-content">
                    ...
                    This is an open source project, The code is available on the GitHub - <a href="https://github.com/Vaibhav2codes/YogaPostureguide">https://github.com/Vaibhav2codes/YogaPostureguide</a>
                ...
                <div className="developer-info">
                    ...
                    <p className="about-content">I am Vaibhav, I am Software Developer,gaming enthusiast. 
                    </p>
                    <h4>Contact</h4>
                    <a href="https://www.instagram.com/vaibhav_02.11/"><p className="about-content">Instagram</p></a>
                    <a href="https://www.linkedin.com/in/vaibhav-singh-2b259b237/"><p  className="about-content">Linkedin</p></a>
                    <a href="https://github.com/vaibhav2codes"><p  className="about-content">GitHub</p></a>
                </div>
            </div>
        </div>
    )
